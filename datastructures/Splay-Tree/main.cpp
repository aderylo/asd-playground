...
int main() {
  SplayTree<int, int> a;  // both key and value are of int type. They can be of any type. They
                          //  both can be of different type. If key is of nonprimitive type, then <,
                          //  >, == operators must be overloaded. To ensure that value is always
                          //  deep copied, assignment operator (=) must be overloaded.
