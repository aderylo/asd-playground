/**
    ...
    Splay:
        ...
        void insert(int p,int v): Insert after p,( 0 means before the array) an element whose value
is v void insertRange(int pos,Node *s): Insert after pos, an segment denoted by s int query(int
l,int r): Output desired result for [L,R] void addRange(int l,int r,int v): Add v to all the element
in segment [L,R] void output(int l,int r) : Output the segment [L,R]
**/
